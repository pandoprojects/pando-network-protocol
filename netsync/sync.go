...
func (sm *SyncManager) GetChannelIDs() []common.ChannelIDEnum {
	return []common.ChannelIDEnum{
		...
		common.ChannelIDRametronenterpriseVote,
		common.ChannelIDAggregatedRametronenterpriseVotes,
	}
}
...
func (m *SyncManager) handleDataResponse(peerID string, data *dispatcher.DataResponse) {
	...
	case common.ChannelIDRametronenterpriseVote:
		vote := &core.RametronenterpriseVote{}
		err := rlp.DecodeBytes(data.Payload, vote)
		if err != nil {
			m.logger.WithFields(log.Fields{
				"channelID": data.ChannelID,
		...
		// 	"peer":       peerID,
		// }).Debug("Received rametronenterprise vote")
		m.handleRametronenterpriseVote(vote)
	case common.ChannelIDAggregatedRametronenterpriseVotes:
		vote := &core.AggregatedRametronenterpriseVotes{}
		err := rlp.DecodeBytes(data.Payload, vote)
		if err != nil {
			m.logger.WithFields(log.Fields{
				"channelID": data.ChannelID,
		...
		m.logger.WithFields(log.Fields{
			...
			"vote.Multiplies": vote.Multiplies,
			"peer":            peerID,
		}).Debug("Received aggregated rametronenterprise vote")
		m.handleAggregatedRametronenterpriseVotes(vote)
...
func (sm *SyncManager) handleRametronenterpriseVote(vote *core.RametronenterpriseVote) {
	sm.PassdownMessage(vote)
}

func (sm *SyncManager) handleAggregatedRametronenterpriseVotes(vote *core.AggregatedRametronenterpriseVotes) {
	sm.PassdownMessage(vote)
}
