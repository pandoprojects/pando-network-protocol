...
import (
	...
	"github.com/pandoprojects/pando/crypto/sha3"
)
...
const (
	...
	// ChannelIDRametronenterprise indicates the channel for rametronenterprise vote messages
	ChannelIDRametronenterpriseVote

	// ChannelIDAggregatedRametronenterpriseVotes indicates the channel for rametronenterprise aggregated vote messages
	ChannelIDAggregatedRametronenterpriseVotes
)
...
const (
	...
	// NodeTyperametronenterprise indicates the node/peer is an rametronenterprise
	NodeTypeRametronenterprise
)
