...
const (
	...
	// CfgNodeType indicates the type of the node, e.g. blockchain node/ node
	...
	// CfgConsensusRametronenterpriseVoteQueueSize defines the capacity of Rametronenterprise vote message queue.
	CfgConsensusRametronenterpriseVoteQueueSize = "consensus.rametronenterpriseVoteQueueSize"
	...
	// CfgDebugLogSelectedRametronenterprisePs to enable logging of selected rametronenterpriseps
	CfgDebugLogSelectedRametronenterprisePs = "debug.logSelectedRametronenterprisePs"
)
...
func init() {
	...
	viper.SetDefault(CfgConsensusRametronenterpriseVoteQueueSize, 100000)
	...
	viper.SetDefault(CfgMetricsServer, "guardian-metrics.pandoprojects.org")
