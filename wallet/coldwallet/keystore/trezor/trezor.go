...
func GetEmptyObj(msgType MessageType) interface{} {
	...
	case 55:
		...
		return &v
	case 56:
		v := reflect.Indirect(reflect.New(t)).Interface().(PandoGetAddress)
		return &v
	case 57:
		v := reflect.Indirect(reflect.New(t)).Interface().(PandoAddress)
		return &v
	case 58:
		v := reflect.Indirect(reflect.New(t)).Interface().(PandoSignTx)
		return &v
	case 59:
		v := reflect.Indirect(reflect.New(t)).Interface().(PandoTxRequest)
		return &v
	case 60:
		v := reflect.Indirect(reflect.New(t)).Interface().(PandoTxAck)
		return &v
	case 61:
	...
	case 63:
		...
		return &v
	case 64:
		v := reflect.Indirect(reflect.New(t)).Interface().(PandoSignMessage)
		return &v
	case 65:
		v := reflect.Indirect(reflect.New(t)).Interface().(PandoVerifyMessage)
		return &v
	case 66:
		v := reflect.Indirect(reflect.New(t)).Interface().(PandoMessageSignature)
		return &v
	case 100:
