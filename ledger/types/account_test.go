...
// func TestUpdateAccountPTXReward(t *testing.T) {
// 	assert := assert.New(t)
...
// 	acc.UpdateAccountPTXReward(currentBlockHeight)
// 	assert.Equal(int64(1e12), acc.Balance.PandoWei.Int64())
// 	assert.Equal(int64(189812000), acc.Balance.PTXWei.Int64())
// 	assert.Equal(uint64(1000), acc.LastUpdatedBlockHeight)

// 	// Underflow: Should not update account if reward is less than 1 PTX
// 	acc = &Account{
// 		LastUpdatedBlockHeight: 1,
...
// 	acc.UpdateAccountPTXReward(currentBlockHeight)
// 	assert.Equal(int64(1000), acc.Balance.PandoWei.Int64())
// 	assert.Equal(int64(2000), acc.Balance.PTXWei.Int64())
...
// 	acc.UpdateAccountPTXReward(currentBlockHeight)
// 	assert.Equal(int64(1e12), acc.Balance.PandoWei.Int64())
// 	assert.Equal(int64(1899999812000), acc.Balance.PTXWei.Int64())
...
// 		}
// 	}()
// 	acc.UpdateAccountPTXReward(currentBlockHeight) // Should panic
// }
