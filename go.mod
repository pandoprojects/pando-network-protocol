module github.com/pandoprojects/pando
...
replace github.com/pandoprojects/pando/rpc/lib/rpc-codec/jsonrpc2 v0.0.0 => ./rpc/lib/rpc-codec/jsonrpc2/

replace github.com/pandoprojects/pando/common v0.0.0 => ./common
