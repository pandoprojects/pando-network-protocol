...
import (
	...
	"github.com/pandoprojects/pando/common/timer"
	"github.com/pandoprojects/pando/p2p/connection/flowrate"
	"github.com/pandoprojects/pando/p2p/types"
...
func CreateConnection(netconn net.Conn, config ConnectionConfig) *Connection {
	...
	channelRametronenterpriseVote := createDefaultChannel(common.ChannelIDRametronenterpriseVote)
	channelRametronenterpriseAggregatedVotes := createDefaultChannel(common.ChannelIDAggregatedRametronenterpriseVotes)
	channels := []*Channel{
		&channelCheckpoint,
		&channelHeader,
		&channelBlock,
		...
		&channelGuardian,
		&channelNATMapping,
		&channelRametronenterpriseVote,
		&channelRametronenterpriseAggregatedVotes,
	}
