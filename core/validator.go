...
func (s *ValidatorSet) HasMajorityVotes(votes []Vote) bool {
	...
	return lhs.Mul(votedStake, three).Cmp(rhs.Mul(s.TotalStake(), one)) > 0
}
...
var (
	...
	MinValidatorStakeDeposit10000K *big.Int
)
...
func init() {
	...
	MinValidatorStakeDeposit10000K = new(big.Int).Mul(new(big.Int).SetUint64(10000000), new(big.Int).SetUint64(1000000000000000000))
}
