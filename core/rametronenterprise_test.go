...
func TestRametronenterpriseAggregateVote(t *testing.T) {
	vote := NewAggregatedRametronenterpriseVotes(common.HexToHash("deadbeef"))
	...
	vote2 := NewAggregatedRametronenterpriseVotes(common.HexToHash("ff"))
	...
	vote2 = NewAggregatedRametronenterpriseVotes(common.HexToHash("deadbeef"))
	...
	// should keep order
	v1 := NewAggregatedRametronenterpriseVotes(common.HexToHash("deadbeef"))
	v2 := NewAggregatedRametronenterpriseVotes(common.HexToHash("deadbeef"))
	v3 := NewAggregatedRametronenterpriseVotes(common.HexToHash("deadbeef"))
...
func TestRametronenterpriseAggregateVoteMerge(t *testing.T) {
	blockHash := common.HexToHash("deadbeef")

	// vote: [a1];
	vote := NewAggregatedRametronenterpriseVotes(blockHash)
	vote.Addresses = append(vote.Addresses, common.HexToAddress("a1"))
	...
	// vote: [a1, c3]; vote2: [a1]
	vote2 := NewAggregatedRametronenterpriseVotes(blockHash)
	vote2.Addresses = append(vote2.Addresses, common.HexToAddress("a1"))
	vote2.Multiplies = append(vote2.Multiplies, 3)
...
func TestRametronenterpriseAggregateVoteMergeSubset(t *testing.T) {
	blockHash := common.HexToHash("deadbeef")
