...
type GetBlockResultInner struct {
	...
	RametronenterpriseVotes *core.AggregatedRametronenterpriseVotes `json:"rametronenterprise_votes"`
...
func (t *PandoRPCService) GetBlockByHeight(args *GetBlockByHeightArgs, result *GetBlockResult) (err error) {
	...
	result.HCC = block.HCC
	result.GuardianVotes = block.GuardianVotes
	result.RametronenterpriseVotes = block.RametronenterpriseVotes
...
func (t *PandoRPCService) GetBlocksByRange(args *GetBlocksByRangeArgs, result *GetBlocksResult) (err error) {
	...
	for common.JSONUint64(block.Height) >= startBlockHeight {
		...
		blkInner.RametronenterpriseVotes = block.RametronenterpriseVotes
...
// ------------------------------ GetRametronenpriseKey -----------------------------------

type GetRametronenterpriseInfoArgs struct{}

type GetRametronenterpriseInfoResult struct {
	BLSPubkey string
	BLSPop    string
	Address   string
	Signature string
...
func (t *PandoRPCService) GetRametronenterpriseInfo(args *GetRametronenterpriseInfoArgs, result *GetRametronenterpriseInfoResult) (err error) {
	privKey := t.consensus.PrivateKey()
	blsKey, err := bls.GenKey(strings.NewReader(common.Bytes2Hex(privKey.PublicKey().ToBytes())))
	if err != nil {
		return fmt.Errorf("Failed to get BLS key: %v", err.Error())
...
// ------------------------------ Getrametronenterprisep -----------------------------------

type GetRametronenterprisepByHeightArgs struct {
	Height common.JSONUint64 `json:"height"`
}

type GetRametronenterprisepResult struct {
	BlockHashRametronenterprisepPairs []BlockHashRametronenterprisepPair
}

type BlockHashRametronenterprisepPair struct {
	BlockHash common.Hash
	Rametronenterprises      []*core.Rametronenterprise
}

func (t *PandoRPCService) GetRametronenterprisepByHeight(args *GetRametronenterprisepByHeightArgs, result *GetRametronenterprisepResult) (err error) {
	deliveredView, err := t.ledger.GetDeliveredSnapshot()
	if err != nil {
		return err
	}
	...
	for _, b := range blocks {
		...
		stateRoot := b.StateHash
		blockStoreView := state.NewStoreView(height, stateRoot, db)
		if blockStoreView == nil { // might have bRametronenterprise pruned
			return fmt.Errorf("the RametronenterpriseP for height %v does not exists, it might have bRametronenterprise pruned", height)
		}
		Rametronenterprisep := state.NewRametronenterprisePool(blockStoreView, true)
		Rametronenterprises := Rametronenterprisep.GetAll(false)
		blockHashRametronenterprisepPairs = append(blockHashRametronenterprisepPairs, BlockHashRametronenterprisepPair{
			BlockHash: blockHash,
			Rametronenterprises:      Rametronenterprises,
		})
	}

	result.BlockHashRametronenterprisepPairs = blockHashRametronenterprisepPairs
...
type GetStakeRewardDistributionRuleSetByHeightArgs struct {
	Height  common.JSONUint64 `json:"height"`
	Address string            `json:"address"` // the address of the stake holder, i.e. the guardian or rametronenterprise
}
...
func (t *PandoRPCService) GetStakeRewardDistributionByHeight(
	...
	for _, b := range blocks {
		...
		blockStoreView := state.NewStoreView(height, stateRoot, db)
		if blockStoreView == nil { // might have been pruned
			return fmt.Errorf("the RametronenterpriseP for height %v does not exists, it might have been pruned", height)
		}
...
// ------------------------------ GetRametronenterpriseStakeReturnsByHeight -----------------------------------

type GetRametronenterpriseStakeReturnsByHeightArgs struct {
	Height common.JSONUint64 `json:"height"`
}

type GetRametronenterpriseStakeReturnsByHeightResult struct {
	RametronenterpriseStakeReturns []state.StakeWithHolder
}

func (t *PandoRPCService) GetRametronenterpriseStakeReturnsByHeight(
	args *GetRametronenterpriseStakeReturnsByHeightArgs, result *GetRametronenterpriseStakeReturnsByHeightResult) (err error) {
	deliveredView, err := t.ledger.GetDeliveredSnapshot()
	if err != nil {
		return err
	}
	...
	height := uint64(args.Height)
	result.RametronenterpriseStakeReturns = deliveredView.GetRametronenterpriseStakeReturns(height)

	return nil
}

// ------------------------------ GetAllPendingRametronenterpriseStakeReturns -----------------------------------
...
type GetAllPendingRametronenterpriseStakeReturnsArgs struct {
}

type GetAllPendingRametronenterpriseStakeReturnsResult struct {
	RametronenterpriseHeightStakeReturnsPairs []HeightStakeReturnsPair
}

func (t *PandoRPCService) GetAllPendingRametronenterpriseStakeReturns(
	args *GetAllPendingRametronenterpriseStakeReturnsArgs, result *GetAllPendingRametronenterpriseStakeReturnsResult) (err error) {
	deliveredView, err := t.ledger.GetDeliveredSnapshot()
	if err != nil {
		return err
	}
	...
	cb := func(k, v common.Bytes) bool {
		...
		if err != nil {
			log.Panicf("GetAllPendingRametronenterpriseStakeReturns: Error reading StakeWithHolder %X, error: %v",
				v, err.Error())
		}

		rametronenterpriseHeightStakeReturnsPairs = append(rametronenterpriseHeightStakeReturnsPairs, HeightStakeReturnsPair{
			HeightKey:       string(k),
			RametronenterpriseStakeReturns: srList,
		})
		return true
	}

	prefix := state.RametronenterpriseStakeReturnsKeyPrefix()
	deliveredView.Traverse(prefix, cb)

	result.RametronenterpriseHeightStakeReturnsPairs = rametronenterpriseHeightStakeReturnsPairs
